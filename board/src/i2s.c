...
void MX_I2S2_Init(void)
{
  ...
  hi2s2.Init.DataFormat = I2S_DATAFORMAT_24B; //I2S_DATAFORMAT_16B_EXTENDED; // I2S_DATAFORMAT_16B_EXTENDED; // I2S_DATAFORMAT_24B // I2S_DATAFORMAT_32B;  // I2S_DATAFORMAT_16B; 
